/**
 * @code	#include "hardware/usb_core.h" @endcode
 * @file	libs/hardware/usb_core.h
 * @brief	Based on Arduino USBCore
 */
//###############################################
#ifndef _HARDWARE_USB_CORE_H_
#define _HARDWARE_USB_CORE_H_
//###############################################
#include <hardware/usb_api.h>
//###############################################
/* This definition is useful if you want to reduce the EP_SIZE.
 * At the moment only 64 and 16 are supported. */
#if !defined(USB_EP_SIZE)
...
#define FEATURE_SELFPOWERED_ENABLED     		_BV(0)
#define FEATURE_REMOTE_WAKEUP_ENABLED   		_BV(1)
...
#define USB_ENDPOINT_OUT(addr)                 	LSB_U16((addr) | 0x00)
#define USB_ENDPOINT_IN(addr)                  	LSB_U16((addr) | 0x80)
